import { InjectedAccountWithMeta, InjectedExtension, InjectedProviderWithMeta, ProviderList, Unsubcall, Web3AccountsOptions } from '@polkadot/extension-inject/types';
declare let isWeb3Injected: boolean;
declare let web3EnablePromise: Promise<InjectedExtension[]> | null;
export { isWeb3Injected, web3EnablePromise };
export declare function web3Enable(originName: string): Promise<InjectedExtension[]>;
export declare function web3Accounts({ ss58Format }?: Web3AccountsOptions): Promise<InjectedAccountWithMeta[]>;
