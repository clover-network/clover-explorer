 ...
 */
export declare class GenericEventData extends Tuple {
    #private;
    constructor(registry: Registry, value: Uint8Array, Types: Constructor<import("../types").Codec>[] | undefined, typeDef: TypeDef[] | undefined, meta: RegistryMetadataEvent, section?: string, method?: string);
    /**
 ...
 */
export declare class GenericEvent extends Struct {
