...
export declare class GenericExtrinsicPayload extends Base<ExtrinsicPayloadVx> {
    ...
    /** @internal */
    static decodeExtrinsicPayload(registry: Registry, value: GenericExtrinsicPayload | ExtrinsicPayloadValue | Uint8Array | string | undefined, version?: number): ExtrinsicPayloadVx;
    /**
