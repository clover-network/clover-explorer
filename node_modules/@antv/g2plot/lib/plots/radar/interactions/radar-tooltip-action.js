...
var tooltip_1 = require("@antv/g2/lib/util/tooltip");
var tooltip_2 = tslib_1.__importDefault(require("@antv/g2/lib/chart/controller/tooltip"));
        ...
        if (hintItems.length > 0) {
            ...
            dataArray.forEach(function (mappingData) {
                mappingData.forEach(function (d) {
                    var items = tooltip_1.getTooltipItems(d, geometry_1);
                    var item = items[0];
