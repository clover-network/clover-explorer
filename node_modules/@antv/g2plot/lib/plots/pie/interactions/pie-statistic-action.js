...
var interaction_1 = require("@antv/g2/lib/interaction");
var util_1 = require("@antv/g2/lib/interaction/action/util");
...
var StatisticAction = /** @class */ (function (_super) {
    ...
    StatisticAction.prototype.change = function () {
        ...
        if (event.type.match('legend-item')) {
            var delegateObject = util_1.getDelegationObject(this.context);
            // @ts-ignore
        ...
        if (data) {
            ...
            var annotationOptions_1 = annotations.filter(function (a) { return !util_2.get(a, 'key', '').match('statistic'); });
            var statisticOptions = annotations.filter(function (a) { return util_2.get(a, 'key', '').match('statistic'); });
            ...
            util_2.each(statisticOptions, function (option) {
                var text;
                var transform;
                ...
                annotationOptions_1.push(tslib_1.__assign(tslib_1.__assign({}, option), { html: function (container, view) {
                        ...
                        var style = util_2.isFunction(option.style) ? option.style() : option.style;
                        ...
                        return text ? (util_2.isString(text) ? text : "" + text) : '<div></div>';
                    } }));
    ...
    StatisticAction.prototype.reset = function () {
        ...
        util_2.each(initialStatistic, function (a) {
            view.annotation()[a.type](a);
        });
        view.render(true);
    };
    return StatisticAction;
}(interaction_1.Action));
