...
function transformOptions(params) {
    ...
    return utils_1.deepAssign({}, {
        ...
        options: {
            // yAxis
            yAxis: option_1.transArrayToObject(yField, options.yAxis, 'yAxis should be object.'),
            // geometryOptions
            geometryOptions: [
            ...
            // annotations
            annotations: option_1.transArrayToObject(yField, options.annotations, 'annotations should be object.'),
        },
    });
}
...
function axis(params) {
    ...
    leftView.axis(yField[0], option_1.getYAxisWithDefault(yAxis[yField[0]], types_1.AxisType.Left));
    // 右 Y 轴
    rightView.axis(xField, false);
    rightView.axis(yField[1], option_1.getYAxisWithDefault(yAxis[yField[1]], types_1.AxisType.Right));
    return params;
}
exports.axis = axis;
/**
...
function annotation(params) {
    var chart = params.chart, options = params.options;
    var yField = options.yField, annotations = options.annotations;
    common_1.annotation(util_1.get(annotations, [yField[0]]))(utils_1.deepAssign({}, params, {
        chart: view_1.findViewById(chart, constant_1.LEFT_AXES_VIEW),
        options: {
            annotations: util_1.get(annotations, [yField[0]]),
        },
    }));
    common_1.annotation(util_1.get(annotations, [yField[1]]))(utils_1.deepAssign({}, params, {
        chart: view_1.findViewById(chart, constant_1.RIGHT_AXES_VIEW),
        options: {
            annotations: util_1.get(annotations, [yField[1]]),
        },
    }));
    return params;
}
