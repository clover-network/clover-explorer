...
function tooltip(params) {
    ...
    if (tooltip) {
        if (util_1.isObject(tooltip)) {
            var chartTooltip = utils_1.deepAssign({}, baseTooltipOptions, tooltip);
...
function adaptor(params) {
    ...
    utils_1.flow(field, meta, common_1.theme, axis, tooltip, legend, common_1.interaction, common_1.animation)(params);
}
