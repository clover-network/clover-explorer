...
exports.adaptor = exports.tooltip = exports.transformOptions = void 0;
...
function transformOptions(params) {
    ...
    if (data.length === 1) {
        return utils_1.deepAssign({}, params, {
            options: tslib_1.__assign(tslib_1.__assign({}, options), { meta: util_2.getMeta(options) }),
        });
    }
    return params;
}
...
function geometry(params) {
    ...
    var data = options.data, type = options.type, color = options.color, shape = options.shape, size = options.size, pointStyle = options.pointStyle, shapeField = options.shapeField, colorField = options.colorField, xField = options.xField, yField = options.yField, sizeField = options.sizeField;
...
function adaptor(params) {
    ...
    return utils_1.flow(transformOptions, geometry, meta, axis, legend, tooltip, label, common_1.interaction, scatterAnnotation, common_1.animation, common_1.theme, regressionLine)(params);
}
