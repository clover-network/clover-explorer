...
function field(params) {
    ...
    var formatData = util_1.map(data, function (row, index) {
        ...
        var x = [];
        var y = [];
        row[constant_1.FUNNEL_TOTAL_PERCENT] = row[yField] / sum;
        // 获取左上角，右上角坐标
        if (index) {
...
function label(params) {
    ...
    common_1.geometryLabel(utils_1.findGeometry(chart, 'polygon'))(params);
    return params;
}
/**
 * 转化率组件
...
function dynamicHeightFunnel(params) {
    return utils_1.flow(field, geometry, transpose, label, conversionTag)(params);
}
