...
export function transformOptions(params) {
    ...
    if (data.length === 1) {
        return deepAssign({}, params, {
            options: __assign(__assign({}, options), { meta: getMeta(options) }),
        });
    }
    return params;
}
...
export function adaptor(params) {
    ...
    return flow(transformOptions, geometry, meta, axis, legend, tooltip, label, interaction, scatterAnnotation, animation, theme, regressionLine)(params);
}
