...
var Annotation = /** @class */ (function (_super) {
    ...
    Annotation.prototype.initHTMLContainer = function () {
        this.htmlContainer = this.view.getCanvas().get('el').parentNode.appendChild(document.createElement('div'));
    };
    Annotation.prototype.clearHTMLContainer = function (destroyed) {
    ...
    Annotation.prototype.getAnnotationCfg = function (type, option, theme) {
        ...
        if (type === 'arc') {
            ...
            o = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, restOptions), this.parsePosition(position)), { 
                // html 组件需要指定 parent
                parent: this.htmlContainer, html: wrappedHtml });
        }
        // 合并主题，用户配置优先级高于默认主题
