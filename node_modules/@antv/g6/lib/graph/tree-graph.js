...
var _lib = _interopRequireDefault(require("@antv/hierarchy/lib"));

var _lib2 = require("@antv/util/lib");
...
function (_super) {
  ...
  TreeGraph.prototype.getLayout = function () {
    ...
    if (layout.radial) {
      return function (data) {
        var layoutData = _lib.default[layout.type](data, layout);
    ...
    return function (data) {
      return _lib.default[layout.type](data, layout);
    };
  };
  /**
   * 返回指定节点在树图数据中的索引
  ...
  TreeGraph.indexOfChild = function (children, id) {
    ...
    (0, _lib2.each)(children, function (former, i) {
      if (id === former.id) {
        index = i;
        return false;
      }
  ...
  TreeGraph.prototype.innerAddChild = function (treeData, parent, animate) {
    ...
    (0, _lib2.each)(treeData.children || [], function (child) {
  ...
  TreeGraph.prototype.innerUpdateChild = function (data, parent, animate) {
    ...
    (0, _lib2.each)(data.children || [], function (child) {
  ...
  TreeGraph.prototype.innerRemoveChild = function (id, to, animate) {
    ...
    (0, _lib2.each)(node.get('children'), function (child) {
  ...
  TreeGraph.prototype.findDataById = function (id, parent) {
    ...
    (0, _lib2.each)(parent.children || [], function (child) {
      if (child.id === id) {
        result = child;
        return false;
      }
  ...
  TreeGraph.prototype.layoutAnimate = function (data, onFrame) {
    ...
    this.get('canvas').animate(function (ratio) {
      ...
      (0, _lib2.each)(self.get('removeList'), function (node) {
        var model = node.getModel();
      ...
      callback: function callback() {
        (0, _lib2.each)(self.getNodes(), function (node) {
