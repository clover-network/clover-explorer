...
var _default = {
  ...
  onDragStart: function onDragStart(evt) {
    ...
    this.targets.forEach(function (t) {
      beforeDragNodes.push((0, _lib.clone)(t.getModel()));
    });
  ...
  onDragEnd: function onDragEnd(evt) {
    ...
    if (graph.get('enabledStack')) {
      ...
      graph.pushStack('update', (0, _lib.clone)(stackData_1));
  ...
  updateDelegate: function updateDelegate(e) {
    ...
    if (!this.delegateRect) {
      ...
      var attrs = (0, _lib.deepMix)({}, _global.default.delegateStyle, this.delegateStyle);
