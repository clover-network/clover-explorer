...
function (_super) {
  ...
  ToolBar.prototype.init = function () {
    ...
    if ((0, _lib.isString)(toolBar)) {
      toolBarDOM = (0, _createDom.default)(toolBar);
    }
    ...
    if (pos) {
      (0, _modifyCss.default)(toolBarDOM, {
        top: pos.y + "px",
        left: pos.x + "px"
      });
    }
  ...
  ToolBar.prototype.undo = function () {
    ...
    if (currentData) {
      ...
      graph.pushStack(action, (0, _lib.clone)(currentData.data), 'redo');
  ...
  ToolBar.prototype.redo = function () {
    ...
    if (currentData) {
      ...
      graph.pushStack(action, (0, _lib.clone)(currentData.data));
