...
function (_super) {
  ...
  ImageMiniMap.prototype.initContainer = function () {
    ...
    var container = (0, _createDom.default)("<div class='" + className + "' style='width: " + cWidth + "px; height: " + cHeight + "px; overflow: hidden; position: relative;'></div>");
    ...
    var containerDOM = (0, _createDom.default)("<div class=\"g6-minimap-container\" style=\"position: relative; width: 100%; height: 100%; text-align: center; display: table;\"></div>");
    container.appendChild(containerDOM);
    var span = (0, _createDom.default)("<span style=\"display: table-cell; vertical-align: middle; \"></span>");
    containerDOM.appendChild(span);
    self.set('containerDOM', containerDOM);
    self.set('containerSpan', span);
    var img = (0, _createDom.default)("<img alt=\"\" src=\"" + this.get('graphImg') + "\" style=\"display: inline-block;\" ondragstart=\"return false;\" onselectstart=\"return false;\"/>");
    self.set('imgDOM', img);
    self.updateImgSize();
  ...
  ImageMiniMap.prototype.updateGraphImg = function (img) {
    ...
    var imgDOM = (0, _createDom.default)("<img alt=\"\" src=\"" + img + "\" style=\"display: inline-block;\" ondragstart=\"return false;\" onselectstart=\"return false;\"/>");
