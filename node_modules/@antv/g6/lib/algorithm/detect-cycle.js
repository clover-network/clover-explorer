...
var detectDirectedCycle = function detectDirectedCycle(graph) {
  ...
  while (Object.keys(unvisitedSet).length) {
    ...
    (0, _dfs.default)(graph, firsetUnVisitedKey, callbacks);
  }
...
var detectAllUndirectedCycle = function detectAllUndirectedCycle(graph, nodeIds, include) {
  var _a, _b, _c;
  ...
  var allCycles = [];
  var components = (0, _connectedComponent.default)(graph, false); // loop through all connected components
...
var detectAllDirectedCycle = function detectAllDirectedCycle(graph, nodeIds, include) {
  if (include === void 0) {
    include = true;
  }
  ...
  while (nodeIdx < nodes.length) {
    ...
    var sccs = (0, _connectedComponent.detectStrongConnectComponents)(subgraphNodes).filter(function (component) {
...
var detectAllCycles = function detectAllCycles(graph, directed, nodeIds, include) {
  if (include === void 0) {
    include = true;
  }
