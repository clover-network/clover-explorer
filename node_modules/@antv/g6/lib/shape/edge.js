...
_shape.default.registerEdge('quadratic', {
  ...
  getControlPoints: function getControlPoints(cfg) {
    ...
    if (!controlPoints || !controlPoints.length) {
      ...
      if ((0, _isArray.default)(this.curveOffset)) cfg.curveOffset = cfg.curveOffset[0];
      if ((0, _isArray.default)(this.curvePosition)) cfg.curvePosition = cfg.curveOffset[0];
...
_shape.default.registerEdge('cubic', {
  ...
  getControlPoints: function getControlPoints(cfg) {
    ...
    if (cfg.curveOffset === undefined) cfg.curveOffset = this.curveOffset;
    if (cfg.curvePosition === undefined) cfg.curvePosition = this.curvePosition;
    if ((0, _isNumber.default)(cfg.curveOffset)) cfg.curveOffset = [cfg.curveOffset, -cfg.curveOffset];
    if ((0, _isNumber.default)(cfg.curvePosition)) cfg.curvePosition = [cfg.curvePosition, 1 - cfg.curvePosition];
...
_shape.default.registerEdge('cubic-vertical', {
  ...
  getControlPoints: function getControlPoints(cfg) {
    ...
    if ((0, _isNumber.default)(this.curvePosition)) this.curvePosition = [this.curvePosition, 1 - this.curvePosition];
    var innerPoint1 = {
      x: startPoint.x,
