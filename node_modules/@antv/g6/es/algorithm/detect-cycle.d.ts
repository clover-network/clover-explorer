 ...
 */
export declare const detectAllUndirectedCycle: (graph: IGraph, nodeIds?: string[], include?: boolean) => any[];
/**
 ...
 */
export declare const detectAllDirectedCycle: (graph: IGraph, nodeIds?: string[], include?: boolean) => any[];
/**
 * 查找图中所有满足要求的圈
 * @param graph
 ...
 */
export declare const detectAllCycles: (graph: IGraph, directed?: boolean, nodeIds?: string[], include?: boolean) => any[];
