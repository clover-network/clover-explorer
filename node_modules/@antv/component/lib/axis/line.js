...
var Line = /** @class */ (function (_super) {
    ...
    Line.prototype.processOverlap = function (labelGroup) {
        ...
        if (titleCfg) {
            if (util_1.isNil(titleCfg.offset)) {
                // 调整 title 的 offset
                var length_1 = this.getRotateLength(labelGroup);
     ...
     * @param {IGroup}
     */
    Line.prototype.getRotateLength = function (labelGroup) {
        var labelCfg = this.get('label');
        var customRotate = labelCfg.rotate;
        var groupBbox = labelGroup.getBBox();
        ...
        labels.forEach(function (label) {
            ...
            // 用于计算距离：不区分正负
            var rotate = customRotate || theme_1.default.verticalAxisRotate;
            var length = isVertical ? Math.cos(rotate) : Math.sin(rotate);
            var rotateLength = width * Math.abs(length);
